    ...
    <section className="relative overflow-hidden px-10 pt-24 pb-18 text-center">
      ...
      <div className="relative mx-auto max-w-[820px]">
        <div className="mb-[22px]">
          <Badge tone="magenta">Season 3 · now grading</Badge>
        </div>
        ...
        <p className="mx-auto mb-[34px] max-w-[560px] font-ui text-[18px] leading-[1.55] text-fg-muted">
          Graded, authenticated trading cards for the DJs shaping electronic
          music. Every card sleeved, shot, and provenance-logged before it
          lists.
        </p>
